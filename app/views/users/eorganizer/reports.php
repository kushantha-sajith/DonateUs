...
<section class="home-section">
    ...
    <div class="main-container">
        ...
        <button class="down_btn" onclick="genPDF()" style= " display: block;
    padding: 10px;
    width: 20;
    height: 40px;
    border-radius: 25px;
    ...
    outline: none;
    border: none;
    background-image: linear-gradient(to right, #0A2558, #0e3276, #0A2558);
    cursor: pointer;
    color: #fff;
    text-transform: uppercase;
    background-size: 200%;
    transition: 0.5s;">Download Report</button>
        <div id="section">
            <div class="section">
                <h1><u>Event Request Report - <?php echo date('Y'); ?></u></h1>
                <br>
                <table border="2" 
                        <th>  Donation ID   </th>
                        <th>  Donor Name  </th>
