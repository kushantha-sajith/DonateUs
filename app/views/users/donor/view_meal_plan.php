    ...
    <section class="home-section">
      ...
      <div class="main-container">
        ...
        <div class="gigcontainer">
          ...
          <img src="<?php echo URLROOT; ?>/img/<?php echo $data['img'];  ?>" alt="" />

          </div><!-- eo box -->
          <div class="btns2">
              <a href="<?php echo URLROOT;?>/donor/viewCalendarDonor/<?php echo $data['id'];  ?>"><button class="btn-back">Back</button></a>
          </div> 
