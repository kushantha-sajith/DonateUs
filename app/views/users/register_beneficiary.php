...
<body>
    ...
    <div class="forms-log-container">
        <div class="signin-signup">
            <form action="<?php echo URLROOT; ?>/users/register_beneficiary" class="sign-up-form" method="POST">
                ...
                <br>
                <p class="social-text">Already have an Account? <a href="<?php echo URLROOT; ?>/users/login_beneficiary">Login here</a></p>
