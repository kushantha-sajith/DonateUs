...
<body>
    ...
    <div class="forms-log-container">
        <div class="signin-signup">
            <form autocomplete="off" action="<?php echo URLROOT; ?>/users/login" class="sign-in-form" method="POST">
                ...
                <br>
                <p class="social-text">Don't have an Account? <a href="<?php echo URLROOT; ?>/users/register">SignUp here</a></p>
