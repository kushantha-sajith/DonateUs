            ...
            <form action="">
                ...
                <div class="formfirst">
                    <div class="details personal">
                        <div class="fields">
                            ...
                            <div class="input-field">
                                ...
                                <input type="" disabled placeholder="<?php echo $reqData->due_date; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="button-container">
                                    <button id="confirm-yes" type="button"
                                            onclick="location.href='<?php echo URLROOT; ?>/adminPages/acceptRequest/<?php echo $reqData->id; ?>'">
                                        Yes
                                    </button>
                        ...
                        <button type="button"
                                onclick="location.href='<?php echo URLROOT; ?>/adminPages/rejectReqNote/<?php echo $reqData->id; ?>'"
                                class="abc">Reject
                        </button>
                    </div>
                </div>
