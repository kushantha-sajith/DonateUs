...
<section class="home-section">
    ...
    <div class="main-container">
        ...
        <div id="section">
            <div class="section">
                <h1>Donation Request Report - <?php echo date('Y'); ?> <?php echo date('M'); ?></h1>
...
<script>
    function pieChart() {
        $.ajax({
            url: "http://localhost/DonateUs/Stats/mRequestStatus",
            method: 'GET',
            dataType: 'JSON',
            success: function (response1) {
                ...
                //setup pie chart
                const data = {
                    labels: [response1.ongoing, response1.completed, response1.rejected],
                    datasets: [{
                        label: 'No. of Donations',
                        data: [response1.ongoingCount.num_rows, response1.completedCount.num_rows, response1.rejectedCount.num_rows],
                        borderWidth: 1
                    }]
                };
                //config pie chart
    ...
    function donutChart() {
        $.ajax({
            url: "http://localhost/DonateUs/Stats/mDonationQuantity",
            method: 'GET',
            dataType: 'JSON',
