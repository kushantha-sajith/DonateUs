    ...
    <main>
        ...
        <?php foreach ($data['indDonors'] as $indDonors) : ?>
            <div class="cards_heading cards_color">
                ...
                <div>Individual</div>
                <div><?php echo $indDonors->zipcode; ?></div>
                <div>
                    <div style="text-align: center;"><a
                            href="<?php echo URLROOT; ?>/pages/userDetails/<?php echo $indDonors->id; ?>">
        ...
        <?php foreach ($data['corpDonors'] as $corpDonors) : ?>
            <div class="cards_heading cards_color">
                ...
                <div>Corporate</div>
                <div><?php echo $corpDonors->zipcode; ?></div>
                <div>
                    <div style="text-align: center;"><a
                            href="<?php echo URLROOT; ?>/pages/userDetails/<?php echo $corpDonors->id; ?>">
                            <button class="btnview">View More</button>
                        </a></div>
                </div>
            </div>
