                        ...
                        <div class="details personal">
                            <div class="fields">
                                <div class="input-field">
                                    ...
                                    <input type="text" value="<?php echo $userData->org_name; ?>" disabled>
                                </div>
                                <div class="input-field">
                                    <label>Organization Type</label>
                                    <input type="text" value="<?php echo $userData->org_type; ?>" disabled>
                                </div>
                                <div class="input-field">
                                    <label>Email</label>
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="text" value="<?php echo $userData->emp_name; ?>" disabled>
                                </div>
                                <div class="input-field">
