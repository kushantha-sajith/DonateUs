      ...
      <main>
          ...
          <?php foreach($data['pendingRequests'] as $pendingRequests) : ?>
              <div class="cards_heading cards_color">
                  ...
                  <div>
                      <div style="text-align: center;"> <a href="<?php echo URLROOT; ?>/pages/pendingRequestDetails/<?php echo $pendingRequests->id; ?>"> <button class="btnview">View More</button> </a></div>
                  </div>
              </div>
          <?php endforeach; ?>
      </main>
