                    ...
                    <div class="details personal">
                        <div class="fields">
                            <div class="input-field" id="description">
                                ...
                                <textarea disabled placeholder="<?php echo $eventData->rejection_note; ?>"></textarea>
                            </div>
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" disabled placeholder="<?php echo $eventData->NIC; ?>">
                            </div>
                            <div class="input-field">
                                <label>Budget</label>
                            ...
                            <div class="input-field">
                                ...
                                <input type="" disabled placeholder="<?php echo $eventData->rejected_date; ?>">
                            </div>
                            <div class="input-field">
